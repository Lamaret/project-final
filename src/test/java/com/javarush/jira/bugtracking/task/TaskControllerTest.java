...
class TaskControllerTest extends AbstractControllerTest {
    ...
    void updateTaskWhenStateNotChanged() throws Exception {
        ...
        TaskToExt sameStateTo = new TaskToExt(TASK2_ID, taskTo2.getCode(), taskTo2.getTitle(), "Trees desc", taskTo2.getTypeCode(),
                taskTo2.getStatusCode(), "normal", null, 4, taskTo2.getParentId(), taskTo2.getProjectId(), taskTo2.getSprintId(), java.util.Set.of());
        perform(MockMvcRequestBuilders.put(TASKS_REST_URL_SLASH + TASK2_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateTaskWhenProjectNotExists() throws Exception {
        TaskToExt notExistsProjectTo = new TaskToExt(TASK2_ID, "epic-2", "Trees UPD", "task UPD", "epic", "in_progress", "high", null, 4, null, NOT_FOUND, SPRINT1_ID, java.util.Set.of());
        perform(MockMvcRequestBuilders.put(TASKS_REST_URL_SLASH + TASK2_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateTaskWhenChangeProject() throws Exception {
        TaskToExt changedProjectTo = new TaskToExt(TASK2_ID, "epic-2", "Trees UPD", "task UPD", "epic", "in_progress", "high", null, 4, null, PROJECT1_ID + 1, SPRINT1_ID, java.util.Set.of());
        perform(MockMvcRequestBuilders.put(TASKS_REST_URL_SLASH + TASK2_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void updateSprintIdWhenDev() throws Exception {
        TaskToExt changedSprintTo = new TaskToExt(TASK2_ID, "epic-2", "Trees UPD", "task UPD", "epic", "in_progress", "high", null, 4, null, PROJECT1_ID, SPRINT1_ID + 1, java.util.Set.of());
        perform(MockMvcRequestBuilders.put(TASKS_REST_URL_SLASH + TASK2_ID)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void createTaskInvalid() throws Exception {
        TaskToExt invalidTo = new TaskToExt(null, "", null, null, "epic", null, null, null, 3, null, PROJECT1_ID, SPRINT1_ID, java.util.Set.of());
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
    ...
    void createTaskWhenProjectNotExists() throws Exception {
        TaskToExt notExistsProjectTo = new TaskToExt(null, "epic-1", "Data New", "task NEW", "epic", "in_progress", "low", null, 3, null, NOT_FOUND, SPRINT1_ID, java.util.Set.of());
        perform(MockMvcRequestBuilders.post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(writeValue(notExistsProjectTo)))
                .andDo(print())
